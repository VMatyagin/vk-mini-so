...
import { Area, Brigade, PanelProps, Shtab } from "../../types";
...
export const QuotasPanel: FC<PanelProps> = observer(({ id, viewId }) => {
                    ...
                    <tbody>
                        ...
                        <LazyList
                            ...
                            customRender={(brigades) => {
                                if (sort === "area") {
                                    return renderSortedByAreaOrShtab(
                                        brigades,
                                        renderFn,
                                        "area"
                                    );
