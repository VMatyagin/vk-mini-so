...
export const EventAPI = {
    ...
    async updateEvent(
        ...
        const { data } = await patch(`/api/event/${eventId}/`, event);
        return data;
    },
    ...
    async wantGo(id: number): Promise<EventType> {
        const { data } = await post(`/api/event/${id}/go/`, {});
        return data;
    },
    async wontGo(id: number): Promise<EventType> {
        const { data } = await post(`/api/event/${id}/ungo/`, {});
        return data;
    }
};
